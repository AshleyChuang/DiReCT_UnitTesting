...
namespace DiReCT
{
    public partial class DiReCTCore
    {
        ...
        public void CoreDMFunctionProcessor(WorkItem workItem)
        {
            if (workItem == null)
            {
                throw new ArgumentNullException("The workItem passed to CoreDMFunctionProcessor cannot be null.");
            }
        ...
        public int SaveRecordToBuffer(dynamic record)
        {
            ...
            if (record == null)
            {
                throw new ArgumentNullException("The record passed to SaveRecordToBuffer cannot be null.");
            }
                               ...
                               Object asyncState)
        {
            if (recordData == null)
            {
                throw new ArgumentNullException("The recordData passed to CoreSaveRecord cannot be null.");
            }
            bool HasEnqueued = true;
            try
            {
                // Initialize workItem
                WorkItem workItem
